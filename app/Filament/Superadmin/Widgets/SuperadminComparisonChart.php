...
class SuperadminComparisonChart extends ChartWidget
{
    protected ?string $heading = 'Pemasukan vs Pengeluaran (Semua Pasangan)';
    ...
    protected function getData(): array
    {
        ...
        $this->heading = 'Pemasukan vs Pengeluaran Semua Pasangan (6 Bulan hingga '.$base->translatedFormat('F Y').')';
